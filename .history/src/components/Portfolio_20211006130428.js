					...
					<div className="row ">
						...
						<div className="col-12  col-lg-6  ">
							...
							<Card
								...
								description="A shopping Cart app"
								about="This is a fullstack shopping cart app built with React, Redux, firebase, Heroku, I implemented stripe payment checkout and also created a node server to handle credit card stripe payment . I used ES6-ES10 javascript features, you can add to cart, increase and decrease an Item in the cart, You can view a single Item and also add it to the cart on the fly."
								link="https://shoping-store.netlify.app/"
							/>
						</div>
