            ...
            <div className="row ">
              <div className="col-12  col-lg-6  ">
                <Card
                  ...
                  about="This is a fullstack application that allows people that have needs make requisition, other users can volunteer to meet their need . On volunteering you create a message flow between you and the user which allows you to send them a direct message in real time."
