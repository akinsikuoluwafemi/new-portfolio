                        ...
                        <div className="col-12 col-lg-6 ">
                            <h3 className="text-white pb-4 font-weight-thin head--spacing">About Me</h3>
                                        <p className="row pr-5 text-success text--spacing">
                                            ...
                                            I am currently a Programme Assistant in&nbsp; <a target="_blank" rel="noopener noreferrer" href="https://help.pluralsight.com/help/gads-2020"> Gads 2020</a>&nbsp; and in the <a href="https://buildforsdg.andela.com/projects" target="_blank" rel="noopener noreferrer" >buildforsdg challenge</a>, with Google, Facebook and Andela.
                                </p>
                                <p className="row pr-5 text-success text--spacing">
