					...
					<div className="row ">
						...
						<div className="col-12  col-lg-6  ">
							...
							<Card
								...
								description="A shopping Cart app"
								about="This is a fullstack shopping cart app built with React, Redux, firebase, Heroku, Google Auth, I implemented stripe payment checkout and also created a node server to handle credit card stripe payment on the backend. Every ossible thing you can do on an e-commerce app is possible ."
								link="https://shoping-store.netlify.app/"
							/>
						</div>
