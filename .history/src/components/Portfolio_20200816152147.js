            ...
            <div className="bg-root pt-4">
                <div className="container px-3 py-4 pb-lg-5 py-lg-5" >
                    ...
                    <div className="row ">
                        ...
                        <div className="col-12  col-lg-6  ">
                            <Card image={biking} header="Boulder Bike Tour" description="React and Rails Application" about="This is a fullstack application, I used rails for the backend and react for the fron end, this app allows users see the location of riders on google map in real time." link="https://writia.herokuapp.com/" />
