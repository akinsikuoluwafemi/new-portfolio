            ...
            <div>
                <div className="bg-root py-5">
                    <div className="container">
                        ...
                        <p className="row pr-5 text-success text--spacing ">
                            I have solid cross-organizational and cross-cultural experience from the banking sector and the manufacturing sector where I learnt soft skills like collaboration, prior to my tech career.
                        </p>             
                            <div>
