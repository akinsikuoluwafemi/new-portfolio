								...
								<div className="row row__wrapper" style={props}>
									<div className="col-12 col-lg-6 ">
										...
										<p className="row pr-5 text-success text--spacing">
											I am an agile minded Software Engineer with a growth Mindset, I am great at communication and also love giving and receiving feedback from the people I work with.
										</p>
										<p className="row pr-5 text-success text--spacing">
