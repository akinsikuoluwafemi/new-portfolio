                        ...
                        <div className="col-12 col-lg-6 ">
                            <h3 className="text-white pb-4 font-weight-thin head--spacing">About Me</h3>
                                        <p className="row pr-5 text-success text--spacing">
                                            ...
                                            I am currently a Programme Assistant in Gads 2020 and <a style={{displ}} href="https://buildforsdg.andela.com/projects" target="_blank" rel="noopener noreferrer" >buildforsdg challenge &nbsp;</a>, with Google, Facebook and Andela.
                                </p>
                                <p className="row pr-5 text-success text--spacing">
