        ...
        <div className="text-white">
            ...
            <div className="tab-content" id="myTabContent">
                ...
                <div className="tab-pane fade" id="education" role="tabpanel" aria-labelledby="education-tab">
                    <div>
                        <p className="tools__name"><a href="https://www.francecompetences.fr/recherche/rncp/27099/"></a>"Full-Stack Developer" bachelor's-level diploma -<span className="tools__description">OpenClassrooms</span></p>
