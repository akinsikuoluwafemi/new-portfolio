...
import gatsby from '../images/sketch'
    ...
    return (
        <div className="text-white">
            ...
            <ul className="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li className="nav-item">
                    <a className="nav-link mr-md-0 mr-lg-3 h4" id="experience-tab" data-toggle="tab" href="#experience" role="tab" aria-controls="experience" aria-selected="false">Volunteer</a>
                </li>
                <li className="nav-item">
