          ...
          <div className="row">
            <div className="col-12 col-lg-6 ">
              ...
              <p className="row pr-5 text-success text--spacing">
                I like to craft solid and scalable software engineering products
            ...
            <div className="col-12 col-lg-6">
              ...
              <p className="row pt-4 pl-2 text-white text--spacing">
                ...
                I also do things like, In building JavaScript applications, I'm
                equipped with just the right tools, and can absolutely function
                independently of them to deliver fast, resilient solutions
                optimized for scale — performance and scalabilty are priorities
                on my radar.
              </p>
