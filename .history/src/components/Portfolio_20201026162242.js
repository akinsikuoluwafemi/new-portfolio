                ...
                <div className="container px-3 py-4 pb-lg-5 py-lg-5" >
                    ...
                    <div className="row ">
                        ...
                        <div className="col-12  col-lg-6">
                            ...
                            <Card image={oakhomesng} header="Oakwood Homes & Construct" description="React P" about="This is a Real Estate website I built for a team in Lekki, Lagos Nigeria." link="https://oakhomesng.com/" />
                        </div>
