...
const Furrow = () => {
  return <a href="https://furrow.studio/" target="_blank" rel="noopener noreferrer">Furrow.Studio</a>;
}
			...
			<div className="bg-root pt-4">
                ...
                /> */}
							<Card
								...
								about="This is a clone of the furrow.studio website, made with gatsby js, I used custom cursors, canvas api framer motion for animations and lots of new react 16 features like useReducer, "
								link="https://peeps-frontend.vercel.app"
