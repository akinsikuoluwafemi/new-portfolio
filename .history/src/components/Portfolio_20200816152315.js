                ...
                <div className="container px-3 py-4 pb-lg-5 py-lg-5" >
                    ...
                    <div className="row ">
                        ...
                        <div className="col-12  col-lg-6   ">
                            <Card image="https://images.ctfassets.net/clveum0ikkbk/3PAwD9ujeEEQ4sy22W0KEG/1d0f26299dd1646a74824cbe9cad460a/weather-app.jpg?w=1024&h=576&q=100" header="Cloud 24" description="Javascript Web Application" about="Cloud 24 allows users to extract weather informations, like temperature, wind-direction, pressure e.t.c." link="https://akinsikuoluwafemi.github.io/Cloud24/" />

                        </div>

                        <div className="col-12  col-lg-6  ">
                            <Card image={biking} header="Boulder Bike Tour" description="React and Rails Application" about="This is a fullstack application that lets users know when the biking event , I used rails on the backend and react on the front end, this app allows users see the exact location of riders on google map in real time." link="https://writia.herokuapp.com/" />
