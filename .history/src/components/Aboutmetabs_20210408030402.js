		...
		<div className="text-white">
			<ul className="nav nav-tabs" id="myTab" role="tablist">
				<li className="nav-item">
					<a
						className="nav-link active mr-md-0 mr-lg-3 h4"
						id="skills-tab"
						data-toggle="tab"
						href="#skills"
						role="tab"
				...
				<li className="nav-item">
					<a
						className="nav-link mr-md-0 mr-lg-3 h4"
						id="experience-tab"
						data-toggle="tab"
						href="#experience"
						role="tab"
			...
			<div className="tab-content" id="myTabContent">
				<div className="tab-pane fade show active" id="skills" role="tabpanel" aria-labelledby="skills-tab">
					<div className="pt-3">
						...
						<div className="d-flex ">
							...
							<ul className="list__item ">
								...
								<div className="d-flex  mb-3">
									<img src={gat} style={{ background: 'white' }} className="tools-logo" alt="" />
					...
					<div>
						<p className="tools__name">
							User experience design - <span className="tools__description">UI/UX</span>
						</p>
				...
				<div className="tab-pane fade" id="experience" role="tabpanel" aria-labelledby="experience-tab">
					<div>
						<p className="tools__name">
							#GADS - Programme Assistant -{' '}
							<span className="tools__description">Google, Andela & Pluralsight </span>
						</p>
						<p className="tools__description">June 2020 - Dec 2020</p>
					</div>
					<div>
						<p className="tools__name">
							#BuildforSDG Challenge - Programme Assistant -{' '}
							<span className="tools__description">Facebook & Andela </span>
						</p>
						<p className="tools__description">April 2020 - June 2020</p>
					</div>
					<div>
						<p className="tools__name">
							Hackathon4Justice Mentor - <span className="tools__description">Facebook & UNODC </span>
						</p>
						<p className="tools__description">2020 - Jan</p>
					</div>
					<div>
						<p className="tools__name">
							Devc Training With Andela Mentor -{' '}
							<span className="tools__description">Facebook & Andela </span>
						</p>
				...
				<div className="tab-pane fade" id="education" role="tabpanel" aria-labelledby="education-tab">
					<div>
						<p className="tools__name">
							...
							>
								"Full-Stack Developer" bachelor's-level diploma -
							</a>
							<span className="tools__description"> OpenClassrooms</span>
						</p>
						<p className="tools__description">2020 Feb - 2021 Feb</p>
					</div>
					<div>
						<p className="tools__name">
							Stutern Graduate Accelerator - <span className="tools__description">Stutern</span>
						</p>
					...
					<div>
						<p className="tools__name">
							...
							<span className="tools__description">Yaba Colledge of technology</span>
						</p>
