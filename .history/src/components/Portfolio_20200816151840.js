            ...
            <div className="bg-root pt-4">
                <div className="container px-3 py-4 pb-lg-5 py-lg-5" >
                    ...
                    <div className="row ">
                        ...
                        <div className="col-12  col-lg-6  ">
                            <Card image={writia} header="Boulder Bike Tour" description="Ruby On Rails Application" about="This is a fullstack application, ." link="https://writia.herokuapp.com/" />
