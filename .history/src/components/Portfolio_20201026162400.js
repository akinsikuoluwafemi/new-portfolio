                ...
                <div className="container px-3 py-4 pb-lg-5 py-lg-5" >
                    ...
                    <div className="row ">
                        ...
                        <div className="col-12  col-lg-6">
                            ...
                            <Card image={oakhomesng} header="Oakwood Homes & Construct" description="React Projects" about="This is a Website I built in , it hosted the buildforsdg cohort one project" link="https://oakhomesng.com/" />
                        </div>
