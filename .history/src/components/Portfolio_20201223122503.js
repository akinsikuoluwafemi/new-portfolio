            ...
            <div className="row ">
              <div className="col-12  col-lg-6  ">
                <Card
                  ...
                  about="This is a fullstack application that allows users that have needs make requisition so other users can volunteer to meet their need. On volunteering, you can send the user "
