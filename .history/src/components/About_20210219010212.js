                    ...
                    <div className="container">
                        ...
                        <div className="col-12 col-lg-6 ">
                            <h3 className="text-white pb-4 font-weight-thin head--spacing">About Me</h3>
                                        ...
                                        I am an agile minded Software Engineer with a growth ,I am currently a Frontend Engineer at Hazon Holdings. 
                                        </p>
                                <p className="row pr-5 text-success text--spacing">
                                I just completed my bachelors level degree diploma on OpenClassrooms, this scholarship was sponsored by Facebook.
                        </p>
                        <p className="row pr-5 text-success text--spacing ">
                            I have solid cross-organizational and cross-cultural experience from the banking sector, the manufacturing sector.
                        </p>             
                            <div>
