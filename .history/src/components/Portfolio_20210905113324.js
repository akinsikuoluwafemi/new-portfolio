					...
					<div className="row ">
						<div className="col-12  col-lg-6  ">
							<Card
								...
								about="Pantry App is a project I built with my PM and Product Designer in Canada, its focused on helping users reduce food waste. It allows users keep stock of what they have left in their pantry, it also shows users items c"
